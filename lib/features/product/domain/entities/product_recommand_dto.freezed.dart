...
/// Create a copy of RecommandDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? productCode = null,Object? sellerCompanyName = null,Object? categoryFullPath = null,Object? name = null,Object? status = null,Object? thumbnailImageUrl = null,Object? lowestSellingPrice = freezed,Object? lowestPriceStockQuantity = null,Object? tags = null,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
...
as String,lowestSellingPrice: freezed == lowestSellingPrice ? _self.lowestSellingPrice : lowestSellingPrice // ignore: cast_nullable_to_non_nullable
...
class _RecommandDto implements RecommandDto {
  const _RecommandDto({required this.id, required this.productCode, required this.sellerCompanyName, required this.categoryFullPath, required this.name, required this.status, required this.thumbnailImageUrl, required this.lowestSellingPrice, required this.lowestPriceStockQuantity, required final  List<String> tags, @LocalDateTimeConverter() required this.createdAt, @LocalDateTimeConverter() required this.updatedAt}): _tags = tags;
