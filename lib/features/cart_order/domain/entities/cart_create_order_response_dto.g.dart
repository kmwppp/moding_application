...
_CartCreateOrderResponseWrapper _$CartCreateOrderResponseWrapperFromJson(
  Map<String, dynamic> json,
) => _CartCreateOrderResponseWrapper(
  success: json['success'] as bool,
  data: json['data'] == null
      ? null
      : CartCreateOrderResponseDto.fromJson(
          json['data'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$CartCreateOrderResponseWrapperToJson(
  _CartCreateOrderResponseWrapper instance,
) => <String, dynamic>{'success': instance.success, 'data': instance.data};

_CartCreateOrderResponseDto _$CartCreateOrderResponseDtoFromJson(
  Map<String, dynamic> json,
...
_CartCreateOrderDto _$CartCreateOrderDtoFromJson(Map<String, dynamic> json) =>
    _CartCreateOrderDto(
      ...
      items: (json['items'] as List<dynamic>)
          .map(
            (e) => CartCreateOrderItemDto.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      ...
      delivery: json['delivery'] == null
          ? null
          : CartCreateOrderDeliveryDto.fromJson(
...
Map<String, dynamic> _$CartCreateOrderDtoToJson(_CartCreateOrderDto instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_CartCreateOrderItemDto _$CartCreateOrderItemDtoFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$CartCreateOrderItemDtoToJson(
  _CartCreateOrderItemDto instance,
) => <String, dynamic>{
  'id': instance.id,
...
_CartCreateOrderDeliveryDto _$CartCreateOrderDeliveryDtoFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$CartCreateOrderDeliveryDtoToJson(
  _CartCreateOrderDeliveryDto instance,
) => <String, dynamic>{
  'status': instance.status,
...
_CartCreateOrderPaymentDto _$CartCreateOrderPaymentDtoFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$CartCreateOrderPaymentDtoToJson(
  _CartCreateOrderPaymentDto instance,
) => <String, dynamic>{
