...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,orderCode,idempotencyKey,buyerProfileId,buyerBusinessName,sellerProfileId,sellerBusinessName,addressName,recipientName,zipCode,address,addressDetail,phone,deliveryRequest,status,totalAmount,deliveryFee,jejuDeliveryFee,deliveryMethod,rejectionReason,rejectionReasonDetail,claimId,const DeepCollectionEquality().hash(items),delivery,payment,isReviewable,isTaxInvoiceIssued,createdAt,updatedAt]);

@override
String toString() {
  return 'OrderDetailDto(id: $id, orderCode: $orderCode, idempotencyKey: $idempotencyKey, buyerProfileId: $buyerProfileId, buyerBusinessName: $buyerBusinessName, sellerProfileId: $sellerProfileId, sellerBusinessName: $sellerBusinessName, addressName: $addressName, recipientName: $recipientName, zipCode: $zipCode, address: $address, addressDetail: $addressDetail, phone: $phone, deliveryRequest: $deliveryRequest, status: $status, totalAmount: $totalAmount, deliveryFee: $deliveryFee, jejuDeliveryFee: $jejuDeliveryFee, deliveryMethod: $deliveryMethod, rejectionReason: $rejectionReason, rejectionReasonDetail: $rejectionReasonDetail, claimId: $claimId, items: $items, delivery: $delivery, payment: $payment, isReviewable: $isReviewable, isTaxInvoiceIssued: $isTaxInvoiceIssued, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id, String orderCode, String idempotencyKey, int? buyerProfileId, String? buyerBusinessName, int? sellerProfileId, String? sellerBusinessName, String? addressName, String? recipientName, String? zipCode, String? address, String? addressDetail, String? phone, String? deliveryRequest,@JsonKey(fromJson: OrderStatus.fromJson, toJson: OrderStatus.toJson) OrderStatus status, int? totalAmount, int? deliveryFee, int? jejuDeliveryFee, String? deliveryMethod, String? rejectionReason, String? rejectionReasonDetail, int? claimId, List<OrderDetailItemDto> items, OrderDetailDeliveryDto? delivery, OrderDetailPaymentDto? payment, bool? isReviewable, bool? isTaxInvoiceIssued,@LocalDateTimeConverter() DateTime createdAt,@LocalDateTimeConverter() DateTime updatedAt
});
...
as bool?,isTaxInvoiceIssued: freezed == isTaxInvoiceIssued ? _self.isTaxInvoiceIssued : isTaxInvoiceIssued // ignore: cast_nullable_to_non_nullable
