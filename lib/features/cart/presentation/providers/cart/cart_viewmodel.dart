...
class CartViewModel extends _$CartViewModel {
  ...
  bool get isAllSelected {
    ...
    return items.every((e) => state.selectedCartItemIds.contains(e.cartItemId));
  }
  ...
  Future<void> getCartData() async {
    try {
      ...
      state = state.copyWith(
        cartData: response,
        selectedCartItemIds: response.data.map((e) => e.cartItemId).toSet(),
      );
    } catch (e) {
      debugPrint('$e');
    }
  ...
  void toggleSelectAll() {
    ...
    if (isAllSelected) {
      ...
      state = state.copyWith(
        selectedCartItemIds: items.map((e) => e.cartItemId).toSet(),
      );
    }
  }
