...
@override
String toString() {
  return 'RefundAccountRequestDto(bankCode: $bankCode, bankName: $bankName, accountNumber: $accountNumber, accountHolder: $accountHolder)';
}
...
class _RefundAccountRequestDto implements RefundAccountRequestDto {
  const _RefundAccountRequestDto({required this.bankCode, required this.bankName, required this.accountNumber, required this.accountHolder});
